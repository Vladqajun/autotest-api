...
#создали в общем файле т.к. ответ на негативные тесты везде одинаковые (конкретно на этом API)

class ValidationErrorSchema(BaseModel):
    """
    Модель, описывающая структуру самой ошибки валидации API
    """
...
class InternalErrorResponseSchema(BaseModel):
    """
    Модель, описывающая структуру внутренней ошибки
    """
